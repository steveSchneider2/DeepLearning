...
Daniel Bourke's class: Lessons 150 thru 168. 
RUNTIME:  8 minutes... two models, 1 chart (compares resnet to efficientNet)
  (EfficientNet is better)
@author: steve
...
effnet_model.compile(loss='categorical_crossentropy',
                     ...
                     metrics='accuracy')
starttime = time.perf_counter()
print('2nd Model EFFICIENTNETV1...')
...
tps.ChartMnistNetworkChanges(resnetdf,effnetdf, resnetmdlsum, resnetdur,
                         effnetdur,effnetmdlsum,  augmnt, supttl, lftTtl,rhtTtl, filename)
#%% ENDING
